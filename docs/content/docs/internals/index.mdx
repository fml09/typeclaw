...
- [Managed runtime](/docs/internals/managed-runtime) — the immutable workload image, writable state and secrets, restart spool, health probes, and Kubernetes security boundary.
